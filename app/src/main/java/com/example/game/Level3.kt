...
class Level3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btncontinue2.setOnClickListener() {
            ...
            val intent = Intent(this@Level3, levelsactivity::class.java)
            startActivity(intent)
            finish()
        ...
        findViewById<ImageView>(R.id.img_left).setImageResource(arrayoffiles.images3[numLeft]) //random number generator
        findViewById<TextView>(R.id.text_left).setText(arrayoffiles.texts3[numLeft])
        ...
        findViewById<ImageView>(R.id.img_right).setImageResource(arrayoffiles.images3[numRight])
        findViewById<ImageView>(R.id.img_right).startAnimation(a)
        findViewById<TextView>(R.id.text_right).setText(arrayoffiles.texts3[numRight])
        //randend2
