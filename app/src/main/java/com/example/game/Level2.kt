...
class Level2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<ImageView>(R.id.img_left).setImageResource(arrayoffiles.images2[numLeft]) //random number generator
        findViewById<TextView>(R.id.text_left).setText(arrayoffiles.texts2[numLeft])
        ...
        findViewById<ImageView>(R.id.img_right).setImageResource(arrayoffiles.images2[numRight])
        findViewById<ImageView>(R.id.img_right).startAnimation(a)
        findViewById<TextView>(R.id.text_right).setText(arrayoffiles.texts2[numRight])
        //randend2
